                    ...
                    <div className="si-cat-card">
                      <div className="si-cat-img-wrap">
                        {cat.picture ? (
                          ...
                          <div className="si-cat-img-placeholder" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', background: 'rgba(255,255,255,0.05)', fontSize: '2rem' }}>
                            <span>🏷️</span>
                          </div>
                        )}
                      </div>
